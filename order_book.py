...
def process_order(order):
    ...
    if matched_order != None:
        ...
        if order_obj.buy_amount > matched_order.sell_amount:
                ...
                print("partially filled, new_order.buy_amount > matched_order.sell amount, creator_id is ", new_order.creator_id)
        ...
        if matched_order.buy_amount > order_obj.sell_amount:
                ...
                print("partially filled, matched_order.buy_amount>new_order.sell_amount, creator_id is ", new_order.creator_id)                
                session.add(new_order)
                session.commit()
